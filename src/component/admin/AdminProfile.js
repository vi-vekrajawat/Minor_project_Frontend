    ...
    <div style={{ width: "100vw", minHeight: "100vh", backgroundColor: "#f4f7f9", overflowX: "hidden" }}>
      ...
      <div className="d-flex justify-content-between align-items-center bg-primary text-white p-3 flex-wrap">
        <div className="d-flex flex-wrap align-items-center">
          ...
          <Link to="/admin" className="mr-3 text-white nav-link">Dashboard</Link>
          <Link to="/batch-management" className="mr-3 text-white nav-link">Batch Management</Link>
          <Link to="/admin-profile" className="text-white nav-link">Profile</Link>
        </div>
        <div className="d-flex align-items-center mt-2 mt-md-0">
          ...
          />
          <span className="ml-2 font-weight-medium text-white">{user.name || "Admin"}</span>
        </div>
      </div>
      ...
      <div className="d-flex flex-column flex-md-row">
        ...
        <div className="text-center bg-white shadow-sm" style={{ minHeight: "100vh", width: "100%", maxWidth: "220px", flexShrink: 0 }}>
          <div className="mt-5 d-flex flex-column align-items-start">
            <Link to="/admin" className="list-group-item list-group-item-action w-100">Dashboard</Link>
            <Link to="/batch-management" className="list-group-item list-group-item-action w-100">Batch Management</Link>
            <Link to="/admin-profile" className="list-group-item list-group-item-action w-100 active">Profile</Link>
          </div>
        </div>
