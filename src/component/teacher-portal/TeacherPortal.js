        ...
        <div style={{ width: "100vw", minHeight: "100vh", backgroundColor: "#f0f0f0", overflowX: "hidden" }}>
            ...
            <div className="row m-0">
                ...
                <div className="col-12 col-md-9 col-lg-10 p-3">
                    ...
                    {/* Cards Section (Updated for Proper Spacing Like Admin) */}
                    <div className="d-flex flex-wrap">
                        ...
                        >
                            ...
                            <img
                                className="ml-3"
                                src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcR7Av_WNQOfLg8elfZ-Zg2QHuPXRIEtMgoSQ-43jTOZRyTBAhKp"
                                alt=""
                                style={{ height: "20px" }}
                            />
                        </div>
                        ...
                        >
                            ...
                            <img
                                className="ml-3"
                                src="https://downloadr2.apkmirror.com/wp-content/uploads/2024/08/50/66c88e18416fc_com.android.contacts-384x384.png"
                                alt=""
                                style={{ height: "20px" }}
                            />
                        </div>
                        ...
                        <div
                            ...
                            style={{ minWidth: "200px", maxWidth: "250px", backgroundColor: "purple" }}
                        >
                            ...
                            <img
                                className="ml-3"
                                src="https://static.vecteezy.com/system/resources/previews/008/057/414/non_2x/assignment-line-icon-vector.jpg"
                                alt=""
                                style={{ height: "20px" }}
                            />
                        </div>
                        ...
                        >
                            ...
                            <img
                                className="ml-3"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFPHiti9Fs_7BQ0yPl-cwSBxq-aC3_91FEvA&s"
                                alt=""
                                style={{ height: "20px" }}
                            />
                        </div>
                        ...
                        <div>
                            {task?.map((task, index) => (
                                <div key={index} className="mt-3 p-2" style={{ border: "0.1px solid grey" }}>
                                    ...
                                    <p>
                                        <b>DeadLine :</b> {task.deadline?.slice(0, 10)}
                                    </p>
                                    <p>
                                        <b>File :</b> {task.file}
                                    </p>
                                    <p>
                                        <b>Created by :</b> {user.name}
                                    </p>
                                </div>
                            ))}
                        </div>
